        ...
        <tbody>
            ...
            <tr class="odd:bg-white text-center">
                ...
                <td class="px-6 py-4 flex justify-center gap-2">
                    <a href="{{ route('donation.show', $item->id) }}" class="p-2 rounded-md bg-tosca-300 hover:bg-tosca-600">
                    ...
                    <a href="{{ route('donation.edit',$item->id) }}" class="p-2 rounded-md bg-yellow-300 hover:bg-yellow-600">
